...
export const constantRoutes = [
...

  {
    ...
    meta: { title: '积分等级管理', icon: 'el-icon-s-data' },
    alwaysShow: true,
    children: [
      {
        path: 'list',
        ...
        meta: { title: '积分等级列表', icon: 'el-icon-s-claim' }
      },
      {
        path: 'create',
        name: 'coreIntegralGradeCreate',
        component: () => import('@/views/core/integral-grade/form'),
        meta: { title: '新增积分等级', icon: 'el-icon-circle-plus' }
      },
      {
        path: 'edit/:id',
    ...
    children: [
      {
        ...
        meta: { title: '会员列表', icon: 'el-icon-s-custom' }
      }
    ]
  },
    ...
    children: [
      {
        ...
        meta: { title: '借款人列表', icon: 'el-icon-s-custom' }
      },
      {
        path: 'detail/:id',
        name: 'coreBorrowerDetail',
        component: () => import('@/views/core/borrower/detail'),
        meta: { title: '借款人详情', icon: 'el-icon-copy-document' },
        // hidden: true
      },
      {
        path: "info-list",
        ...
        meta: { title: "借款列表", icon: "el-icon-phone" },
      },
      {
        path: "info-detail/:id",
        name: "coreBorrowInfoDetail",
        component: () => import("@/views/core/borrow-info/detail"),
        meta: { title: "借款详情", icon: "el-icon-phone-outline" },
      },
    ]
  },
    ...
    children: [
      {
        ...
        meta: { title: '标的列表', icon: 'el-icon-s-opportunity' }
      },
      {
        path: 'detail/:id',
        name: 'coreLendDetail',
        component: () => import('@/views/core/lend/detail'),
        meta: { title: '标的详情', icon: 'el-icon-s-check' },
        hidden: false
      }
    ]
  },
    ...
    children: [
      {
        ...
        meta: { title: '数据字典', icon: 'el-icon-notebook-1' }
      }
    ]
  },
